...
<body>
  ...
  <header className="masthead text-center text-white">
    <div className="masthead-content">
      <div className="container">
        <h2 className="masthead-subheading mb-0">Chat with {recipient}!</h2>
    ...
    <div class="container">
      <div class="row align-items-center">
        <form action={url} method ="POST" className="newChat">
            <p>New Message</p>

                  <input type="hidden" name ="sender_name" value={sender} readOnly/>

                  <input type="hidden" name ="recipient_name" value={recipient} readOnly/>
