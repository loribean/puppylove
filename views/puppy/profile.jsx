    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <h2 class="display-4">{dog.name}</h2>
            <p>{dog.description}</p>
            <a href={`${url}${dog.id}`}>Go to profile</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <header className="masthead text-center text-white">
    <div className="masthead-content">
      <div className="container">
        ...
        <a href={`${matchesUrl}`} className="btn btn-primary btn-xl rounded-pill mt-5">View your matches!</a>
      </div>
    </div>
    ...
    <div className="bg-circle-4 bg-circle"></div>
          ...
          <div>
            <ul style={{listStyle: "none"}}>{dashList}</ul>
